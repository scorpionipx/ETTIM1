================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : zc Project Overview
===============================================================================

The application wizard has created this zc application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your zc application.
...
zc.h
    ...
    project specific headers and declares the CzcApp application class.
...
zcDlg.h, zcDlg.cpp - the dialog
    These files contain your CzcDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named zc.pch and a precompiled types file named StdAfx.obj.
