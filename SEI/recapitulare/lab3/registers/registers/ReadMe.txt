================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : registers Project Overview
===============================================================================

The application wizard has created this registers application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your registers application.
...
registers.h
    ...
    project specific headers and declares the CregistersApp application class.
...
registersDlg.h, registersDlg.cpp - the dialog
    These files contain your CregistersDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named registers.pch and a precompiled types file named StdAfx.obj.
