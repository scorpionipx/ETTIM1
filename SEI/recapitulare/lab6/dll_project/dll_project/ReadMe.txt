================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : dll_project Project Overview
===============================================================================

The application wizard has created this dll_project application for 
...
dll_project.h
    ...
    project specific headers and declares the Cdll_projectApp application class.

dll_project.cpp
    This is the main application source file that contains the application
    class Cdll_projectApp.
...
dll_projectDlg.h, dll_projectDlg.cpp - the dialog
    These files contain your Cdll_projectDlg class.  This class defines
